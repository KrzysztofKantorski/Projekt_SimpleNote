        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoteId = table.Column<long>(type: "bigint", nullable: false),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    ReactionTypeId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NoteReactions_ReactionTypes_ReactionTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedNotes", x => new { x.NoteId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoteReactions_NoteId_UserId_ReactionTypeId",
                table: "NoteReactions",
                columns: new[] { "NoteId", "UserId", "ReactionTypeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_NoteReactions_ReactionTypeId",
                table: "NoteReactions",
